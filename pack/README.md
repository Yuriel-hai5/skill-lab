<!-- ============================================================
     🤖 如果你是 AI agent，被用户拖了这个包进来：
     先读同目录的 AGENTS.md，那是给你的安装任务书。
     本文件是给人看的说明。
     ============================================================ -->
...
> ## 懒人装法：把压缩包直接拖进 WorkBuddy 对话框
>
> 拖进去，然后说：**「帮我装上」**。
>
> 包根的 **`AGENTS.md`** 是专门为这个场景写的任务书——agent 解压后会读到它，
> 里面含版本探测、解压、复制、生成索引、冲突检查的完整流程。
>
> **想更稳就说全一点**：**「按包里的 AGENTS.md 帮我装上」**。
...
**Q：直接把压缩包拖进对话框，AI 会自己装吗？**
A：**大概率会，但加一句指向更稳。** 拖进去后说「帮我装上」通常就够——
包根的 `AGENTS.md` 是专为这个场景写的任务书，agent 解压后会读到。
但"装上"有歧义，agent 可能理解成"解压到工作区"或"读一遍总结"。
**说「按包里的 AGENTS.md 帮我装上」基本不会跑偏。**
